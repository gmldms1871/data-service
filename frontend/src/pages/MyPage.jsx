                ...
                <div className="divide-y divide-gray-100">
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 mb-4">
                      웹사이트 리뉴얼 작업에 대해 문의드립니다. 현재 저희
                      사이트가 모바일 최적화가 되어있지 않아 반응형 디자인으로
                      리뉴얼하고 싶습니다. 약 10페이지 정도 되는 기업 소개
                      웹사이트입니다.
                    </p>
                    <button className="text-sm bg-blue-50 text-blue-600 px-4 py-1 rounded-md hover:bg-blue-100">
                      답변 확인
                    </button>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-700 mb-4">
                      신규 제품 출시에 따른 마케팅 전략 수립 및 SNS 광고 운영
                      대행 문의드립니다. 5월 중순에 출시 예정인 제품으로, 사전
                      마케팅부터 출시 후 3개월간의 프로모션까지 포괄적인 마케팅
                      서비스가 필요합니다.
                    </p>
                    <button className="text-sm bg-blue-50 text-blue-600 px-4 py-1 rounded-md hover:bg-blue-100">
                      답변 확인
