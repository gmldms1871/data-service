...
const MainPage = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                try {
                    const companiesRes = await fetch('/api/users?sort=rating&limit=4');
                    if (companiesRes.ok) {
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            {/* 메인 배너 */}
            <div className="relative bg-gray-100 flex items-center" style={{ height: '400px' }}>
                <div className="container mx-auto px-4">
                    <div className="w-full md:w-1/2">
                        <h1 className="text-4xl font-bold mb-4">원하는 서비스를<br />자유롭게 찾아보세요</h1>
                        <p className="text-lg text-gray-700 mb-8">전문가와 함께 프로젝트를 성공적으로 완수하세요</p>
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <Link
                                to="/products/add"
                                className="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 transition duration-300 text-center font-semibold"
                            >
                                상품 등록하기
                            </Link>
                        </div>
                ...
                <div className="hidden md:block absolute right-0 top-0 h-full w-1/2 bg-blue-50">
                    <img src="/assets/main-banner.jpg" alt="메인 배너 이미지" className="h-full w-full object-cover" />
                </div>
            </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
                    {categories.length > 0 ? (
                        categories.map(category => (
                            ...
                            >
                                <div className="bg-blue-100 p-3 rounded-full mb-3">
                                    <i className={`fas fa-${category.icon || 'star'} text-blue-600 text-xl`}></i>
                                </div>
                        ...
                        [
                            ...
                            >
                                <div className="bg-blue-100 p-3 rounded-full mb-3">
                                    <i className={`fas fa-${category.icon} text-blue-600 text-xl`}></i>
                                </div>
                                <span className="text-sm text-center">{category.name}</span>
                            </Link>
                        ))
            ...
            <div className="bg-gray-50 py-12">
                <div className="container mx-auto px-4">
                    <div className="flex justify-between items-center mb-8">
                        <h2 className="text-2xl font-bold">인기 기업</h2>
                        <Link to="/companies" className="text-sm text-blue-600 hover:underline">전체보기</Link>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {featuredCompanies.map((company) => (
                            <div key={company.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                                <Link to={`/companies/${company.id}`}>
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="text-gray-600 text-sm mt-2">{company.nickname}</p>
            ...
            <div className="container mx-auto py-12 px-4">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <Link to="/products" className="text-sm text-blue-600 hover:underline">전체보기</Link>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gray-50 py-12">
                <div className="container mx-auto px-4">
                    <h2 className="text-2xl font-bold mb-8 text-center">서비스 이용 방법</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            ...
                            <p className="text-gray-600">원하는 서비스와 전문가를 검색하고 찾아보세요.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <p className="text-gray-600">마음에 드는 서비스에 견적을 요청하고 의뢰하세요.</p>
                        </div>
                        <div className="bg-white p-6 rounded-lg shadow-md text-center">
                            <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                            ...
                            <p className="text-gray-600">서비스 완료 후 리뷰를 남기고 다음 프로젝트를 진행하세요.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-8 text-white">
                    <div className="flex flex-col md:flex-row items-center justify-between">
                        <div className="mb-6 md:mb-0">
                            <h3 className="text-2xl font-bold mb-2">전문가로 등록하고 수익을 창출하세요</h3>
                            <p className="text-white text-opacity-90">프리랜서로 활동하며 더 많은 고객을 만나보세요.</p>
                        </div>
                        <Link
                            to="/products/add"
                            className="bg-white text-blue-600 px-6 py-3 rounded-md font-bold hover:bg-gray-100 transition duration-300"
                        >
                            상품 등록하기
                        </Link>
                    </div>
